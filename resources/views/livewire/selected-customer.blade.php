    ...
    <div class="card shadow-sm h-100 border-0 rounded-3">
        ...
        <div class="card-body py-4" style="min-height: 160px;">
            @if ($customer)
                ...
                <div class="d-flex align-items-center mb-3 text-truncate" title="{{ $customer['email'] }}">
                ...
                <div class="d-flex align-items-center mb-3 text-truncate" title="{{ $customer['alamat'] }}">
                    <i class="bi bi-geo-alt-fill fs-4 text-danger me-3"></i>
                    <div>
                        <div class="text-muted small">Alamat</div>
                        <span class="fs-5">{{ $customer['alamat'] }}</span>
                    </div>
                </div>

                <div class="d-flex align-items-center mb-3 text-truncate" title="{{ $customer['umur'] }} tahun">
                    <i class="bi bi-calendar-fill fs-4 text-info me-3"></i>
                    <div>
                        <div class="text-muted small">Umur</div>
                        <span class="fs-5">{{ $customer['umur'] }} tahun</span>
                    </div>
                </div>

                <div class="d-flex align-items-center text-truncate" title="{{ ucfirst($customer['gender']) }}">
                    <i class="bi bi-gender-ambiguous fs-4 text-secondary me-3"></i>
                    <div>
                        <div class="text-muted small">Gender</div>
                        <span class="fs-5">{{ ucfirst($customer['gender']) }}</span>
                    </div>
                </div>
            @else
